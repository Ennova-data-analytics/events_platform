<template>
  <div>
    <div class="d-flex justify-space-between align-center mb-4">
      <h1 :class="$vuetify.display.mobile ? 'text-h6' : 'text-h5'">Manage Email Templates</h1>
      <v-btn to="/admin/email-templates/create" color="primary" prepend-icon="mdi-plus" :size="$vuetify.display.mobile ? 'small' : 'default'">
