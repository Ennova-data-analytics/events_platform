...
export const EventService = {
  ...
  getEventReferralLinks(eventId) {
    return ApiClient.get(`/referral-links/event/${eventId}`);
  },

  updateReferralLink(linkId, updateData) {
    return ApiClient.put(`/referral-links/${linkId}`, updateData);
  },
